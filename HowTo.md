...
5. **Feed URL**: Paste your raw GitHub link (e.g., `https://raw.githubusercontent.com/.../blacklist.txt`)
6. Set **Refresh Interval**: e.g., every `60` minutes
7. Enable **Status** and save the connector
